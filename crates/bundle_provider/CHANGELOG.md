...
## [0.10.1](https://github.com/flashbots/contender/releases/tag/contender_bundle_provider-v0.10.1) - 2026-05-06
...
- simplified `BundleProviderError`
    - use `thiserror::Error` to replace manual `Display` & `std::error::Error` impls
    - derive `From<RpcError>` in `BundleProviderError::SendBundleError` for better DX (less `map_err`)

---

> Note: changelogs prior to this point were broken. Please excuse the mess.

## [0.5.5](https://github.com/flashbots/contender/releases/tag/contender_bundle_provider-v0.5.5) - 2025-05-14
