...
- spam-stream subcommand for streaming tx specs (relayer use case) ([#589](https://github.com/flashbots/contender/pull/589))
- upgrade contender_core to [v0.11.1](../core/CHANGELOG.md)

## [0.10.1](https://github.com/flashbots/contender/releases/tag/v0.10.1) - 2026-05-06
