...
## [0.10.1](https://github.com/flashbots/contender/releases/tag/contender_report-v0.10.1) - 2026-05-06
...
- added "Transactions" table to HTML report template showing total/successful/failed/failure-rate ([#516](https://github.com/flashbots/contender/issues/516))
...
- add gas quantiles to report ([#464](https://github.com/flashbots/contender/pull/464/changes))
